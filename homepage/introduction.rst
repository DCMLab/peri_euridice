...
.. code:: bash
   ...
   git clone https://github.com/DCMLab/peri_euridice.git
...
* `Jacopo Peri – Euridice (1600) <https://github.com/DCMLab/peri_euridice/archive/refs/heads/main.zip>`__


Data Formats
============

Each piece in this corpus is represented by four files with identical names, each in its own folder. For example, the *Prologo* has the following files:

-  ``MS3/peri_euridice_scene_0.mscx``: Uncompressed MuseScore file including the music and annotation labels.
-  ``notes/peri_euridice_scene_0.tsv``: A table of all note heads contained in the score and their relevant features (not each of them represents an onset, some are tied together)
-  ``measures/peri_euridice_scene_0.tsv``: A table with relevant information about the measures in the score.
-  ``harmonies/peri_euridice_scene_0.tsv``: A list of the included harmony labels (including cadences and phrases) with their positions in the score.
...
.. code:: python
   ...
   labels = ms3.load_tsv('harmonies/peri_euridice_scene_0.tsv')
   notes = ms3.load_tsv('notes/peri_euridice_scene_0.tsv')
...
For questions, remarks etc., please `create an issue <https://github.com/DCMLab/peri_euridice/issues>`__ and feel free to fork and submit pull requests.
